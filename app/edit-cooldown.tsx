...
export default function EditCooldownScreen() {
  ...
  const loadData = async () => {
    try {
      ...
      if (stored) {
        ...
        setExercises(cooldownExercises);
      }
    } catch (error) {
  ...
  const saveData = async (newExercises: Exercise[]) => {
    try {
      ...
      console.log('Error saving cooldown exercises:', error);
    }
  };
