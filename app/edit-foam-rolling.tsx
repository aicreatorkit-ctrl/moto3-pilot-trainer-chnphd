...
export default function EditFoamRollingScreen() {
  ...
  const loadData = async () => {
    try {
      ...
      if (stored) {
        ...
        setExercises(foamRollingExercises);
      }
    } catch (error) {
  ...
  const saveData = async (newExercises: Exercise[]) => {
    try {
      ...
      console.log('Error saving foam rolling exercises:', error);
    }
  };
